...
export const Display_Wrapper = styled.div`
  ...
  @media (max-width: 1800px) {
    right: ${(props: any) => (props.scrollPosition > 2550 ? '250px' : '0px')};
    transition: all ease 0.4s;
    z-index: 100;
  }
  @media (max-width: 1600px) {
    right: ${(props: any) => (props.scrollPosition > 2550 ? '180px' : '0px')};
  }
  @media (max-width: 1450px) {
    right: ${(props: any) => (props.scrollPosition > 2550 ? '60px' : '0px')};
  }
`
